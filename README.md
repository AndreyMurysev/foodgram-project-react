...
Данный сервис узконаправленный и предназначен для публикации и просмотра рецептов. На сервисе присутствует стандартный функционал: авторизация, 
добавление новых рецептов или уже созданных в избранное, а также система динамических тегов, которую может расширять администратор, для удобной
фильтрации рецептов. Так как приложение полностью написано для приложений работающих по API, как и данная версия, то в целом проект возможно
использовать, как основной, так и дополнительный функционал, в частности при знании JS и фреймворка React возможно изменить представление
данных и в целом поменять назначение проекта, создав социальную сеть или сервис с похожим функционалом.
Основной особенностью данного сервиса является возможность, создавать список продуктов, которые нужно купить для приготовления выбранных блюд.

```
В дальнейшем, с целью изучения React, планирую расширить функционал "Список продуктов", предоставив пользователю 
возможность отправлять списки в Telegram.
```
